...
function Contacts() {
    ...
    const handleContactForm = (e) => {
        ...
        if (name && email && message) {
            if (isEmail(email)) {
                // If environment variables are not set, we simulate success for the UI
                ...
                if (serviceID && templateID && publicKey) {
                    emailjs.sendForm(serviceID, templateID, form.current, publicKey)
                        .then((result) => {
                            ...
                            setErrMsg('Failed to send message via EmailJS');
                            setOpen(true);
                        });
                } else {
                    // FALLBACK: Simulate success if EmailJS is not configured
                    ...
                    <div className={styles.contactsForm}>
                        ...
                        >
                            <SnackbarContent
                                ...
                                style={{
                                    backgroundColor: success ? '#4BB543' : theme.primary,
